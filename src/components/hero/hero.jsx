					...
					<div className="svg-wrapper">
						<svg xmlns="http://www.w3.org/2000/svg" width="28" height="42" viewBox="0 0 28 42">
							<g id="Group_14608" data-name="Group 14608" transform="translate(-1795 -770)">
								<g id="Rectangle_6299" data-name="Rectangle 6299" transform="translate(1795 770)" fill="none" stroke="#fff" strokeWidth="1.5">
									<rect width="28" height="42" rx="14" stroke="none"/>
									<rect x="0.75" y="0.75" width="26.5" height="40.5" rx="13.25" fill="none"/>
								</g>
								<line id="Line_9" data-name="Line 9" y2="9" transform="translate(1809.5 778.5)" fill="none" stroke="#fff" strokeWidth="1.5"/>
							</g>
						</svg>
					</div>
				</div>
